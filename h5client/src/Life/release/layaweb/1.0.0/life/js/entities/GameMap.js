...
var GameMap = (function (_super) {
    ...
    GameMap.prototype.setSelect = function (select) {
        ...
        if (this.select == 1 && this.building1ok) {
            this.building.loadImage("res/building1.png");
        }
        else if (this.select == 2 && this.building2ok) {
            this.building.loadImage("res/building2.png");
        }
        else if (this.select == 3 && this.building3ok) {
            this.building.loadImage("res/building3.png");
        }
        else {
